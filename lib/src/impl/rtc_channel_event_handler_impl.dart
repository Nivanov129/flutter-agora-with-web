...
extension RtcChannelEventHandlerExt on RtcChannelEventHandler {
  void process(String channelId, String methodName, dynamic data, [Uint8List? buffer]) {
    ...
    switch (methodName) {
      ...
      case 'ClientRoleChanged':
        clientRoleChanged?.call(
            ClientRoleConverter.fromValue(newData[0]).e, ClientRoleConverter.fromValue(newData[1]).e);
        break;
      case 'UserJoined':
        userJoined?.call(newData[0], newData[1]);
        break;
      case 'UserOffline':
        userOffline?.call(newData[0], UserOfflineReasonConverter.fromValue(newData[1]).e);
        break;
      case 'ConnectionStateChanged':
        connectionStateChanged?.call(ConnectionStateTypeConverter.fromValue(newData[0]).e,
      ...
      case 'RemoteVideoStateChanged':
        remoteVideoStateChanged?.call(newData[0], VideoRemoteStateConverter.fromValue(newData[1]).e,
            VideoRemoteStateReasonConverter.fromValue(newData[2]).e, newData[3]);
        break;
      case 'RemoteAudioStateChanged':
        remoteAudioStateChanged?.call(newData[0], AudioRemoteStateConverter.fromValue(newData[1]).e,
            AudioRemoteStateReasonConverter.fromValue(newData[2]).e, newData[3]);
        break;
      ...
      case 'RemoteSubscribeFallbackToAudioOnly':
        ...
        break;
      case 'RtcStats':
        rtcStats?.call(RtcStats.fromJson(Map<String, dynamic>.from(newData[0])));
        break;
      case 'NetworkQuality':
        networkQuality?.call(newData[0], NetworkQualityConverter.fromValue(newData[1]).e,
            NetworkQualityConverter.fromValue(newData[2]).e);
        break;
      case 'RemoteVideoStats':
        remoteVideoStats?.call(RemoteVideoStats.fromJson(Map<String, dynamic>.from(newData[0])));
        break;
      case 'RemoteAudioStats':
        remoteAudioStats?.call(RemoteAudioStats.fromJson(Map<String, dynamic>.from(newData[0])));
        break;
      ...
      case 'StreamInjectedStatus':
        streamInjectedStatus?.call(newData[0], newData[1], InjectStreamStatusConverter.fromValue(newData[2]).e);
        break;
      case 'StreamMessage':
      ...
      case 'StreamMessageError':
        streamMessageError?.call(
            newData[0], newData[1], ErrorCodeConverter.fromValue(newData[2]).e, newData[3], newData[4]);
        break;
      ...
      case 'ChannelMediaRelayEvent':
        channelMediaRelayEvent?.call(ChannelMediaRelayEventConverter.fromValue(newData[0]).e);
        break;
      ...
      case 'AudioPublishStateChanged':
        audioPublishStateChanged?.call(channelId, StreamPublishStateConverter.fromValue(newData[0]).e,
            StreamPublishStateConverter.fromValue(newData[1]).e, newData[2]);
        break;
      case 'VideoPublishStateChanged':
        videoPublishStateChanged?.call(channelId, StreamPublishStateConverter.fromValue(newData[0]).e,
            StreamPublishStateConverter.fromValue(newData[1]).e, newData[2]);
        break;
      case 'AudioSubscribeStateChanged':
        audioSubscribeStateChanged?.call(channelId, newData[0], StreamSubscribeStateConverter.fromValue(newData[1]).e,
            StreamSubscribeStateConverter.fromValue(newData[2]).e, newData[3]);
        break;
      case 'VideoSubscribeStateChanged':
        videoSubscribeStateChanged?.call(channelId, newData[0], StreamSubscribeStateConverter.fromValue(newData[1]).e,
            StreamSubscribeStateConverter.fromValue(newData[2]).e, newData[3]);
        break;
      ...
      case 'UserSuperResolutionEnabled':
        userSuperResolutionEnabled?.call(
            newData[0], newData[1], SuperResolutionStateReasonConverter.fromValue(newData[2]).e);
        break;
      ...
      case 'FirstRemoteVideoFrame':
        if (firstRemoteVideoFrame != null) {
          ...
          firstRemoteVideoFrame!(json.uid, json.width, json.height, json.elapsed);
        }
        break;
      default:
        print('unhandled $methodName');
        // do nothing
        break;
    }
  }
